 ...
 */
async function handleLimpiarDatos(primaryDb, configuracionGlobal, CARACAS_TIMEZONE, loadInitialDataFn, res) {
    ...
    try {
        ...
        await writeFirestoreDoc(primaryDb, 'app_config', 'main_config', defaultAppConfig, false); // Sobrescribir completamente
        ...
        // Esta función (loadInitialDataFn) debe ser la del server.js y manejar la inicialización.
